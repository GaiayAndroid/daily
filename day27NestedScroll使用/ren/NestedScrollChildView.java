package com.rent.mytestapplication.temp;
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dispatchNestedPreScroll(0, deltaY, mConsumed, mOffset)) {
                    ...
                    int scrollTo = ((View) getParent()).getScrollY() - deltaY;

                    if ((deltaY < 0 && scrollTo <= 0)
                            || (deltaY > 0 && scrollTo > getHeight() - ((View) getParent()).getHeight())) {
